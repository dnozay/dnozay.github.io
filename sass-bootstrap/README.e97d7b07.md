...
`<link rel="stylesheet" type="text/css" href="./dist/css/bootstrap.73e1baae.css">`
...
2. Navigate to the root `/bootstrap` directory, then run `npm install`. npm will look at [package.2bc39299.json](package.2bc39299.json) and automatically install the necessary local dependencies listed there.
...
Copyright 2013 Twitter, Inc under [the Apache 2.0 license](LICENSE.243a4911).
